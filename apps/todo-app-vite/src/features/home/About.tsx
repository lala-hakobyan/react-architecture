export default function About() {
    return (
        <section>
            <h2>About</h2>
            <p>Hello, this is a simple starter Todo app which you can use to add and manage Todos.</p>
            ...
            <p>But since this is a starter app, it only works offline with local mocks.</p>
        </section>
    )
}
